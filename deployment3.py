...
model = load_model('C:\\Users\\Krishna Bhat\\Downloads\\next_word_model.h5')
history = pickle.load(open("C:\\Users\\Krishna Bhat\Downloads\\history (1).p", "rb"))

# Loading unique words and corresponding index
unique_words = np.load('C:\\Users\\Krishna Bhat\\Downloads\\unique_words.npy')
